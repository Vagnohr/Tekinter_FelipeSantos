...
lb3.pack(side=TOP,fill=Y)#comando fill é responsavel do preenchimento 100%, deve usar x para horizontal e deve ser maiusculo
lb4.pack(side=RIGHT,fill=X)#comando fill é responsavel do preenchimento 100%, deve usar x para horizontal e deve ser maiusculo
i.mainloop()